...
// https://github.com/celo-org/celo-blockchain/blob/55599ee95d4151a2502465e0afc7c47bd1acba77/internal/ethapi/api.go#L404
...
// https://github.com/celo-org/celo-blockchain/blob/55599ee95d4151a2502465e0afc7c47bd1acba77/internal/ethapi/api.go#L442
  ...
  app.Commands = []cli.Command {
    ...
    cli.Command {
      ...
      Action: func(c *cli.Context) error {
        ...
        if create {
          tx = types.NewContractCreation(nonce, value, gasLimit, gasPrice, data,0,"nil",0)
        } else {
          tx = types.NewTransaction(nonce, to, value, gasLimit, gasPrice, data,0,"nil",0)
        }
